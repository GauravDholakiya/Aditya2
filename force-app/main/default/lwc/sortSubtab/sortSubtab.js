...
export default class sortLayout extends LightningElement {
  ...
  sortBy(e) {
    ...
    console.log(
      "sortBy:" + e.target.value + "  direction: " + this.sortByDirection
    );
    let detes = [
      {
        sort: this.sortOneValue,
        direction: this.sortByDirection ? "DSC" : "ASC"
      }
    ];
    this.groupTwoValue = "";
  ...
  groupAndSortBy(e) {
    ...
    if (this.sortOneValue == this.groupTwoValue) {
      ...
      detes = [
        ...
        {
          sort: this.groupTwoValue,
          direction: this.thenByDirection ? "DSC" : "ASC"
        }
      ];
    }
    console.log(
      "1 - sortBy:" + this.sortOneValue + " direction: " + this.sortByDirection
        ? "DSC"
        : "ASC"
    );
    console.log(
